...
if(!empty($_GET['histori']) && $_GET['histori'] === 'true'){
   $queryKlinikJadwal      = "
                                SELECT 
                                ...
                                where 
                                    dokter.id = :dokter_id and bill_kasir.status_selesai = 3 and registrasi.tgl_order::date < '".date('Y-m-d')."'";
    $resKlinikJadwal            = $conn->prepare($queryKlinikJadwal);
    $resKlinikJadwal->bindValue(':dokter_id', $_SESSION['dokter_id']);
                        ...
                        <div class="card mt-4">
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <h4>Telekonsultasi Yang Akan Datang</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody id="list_user">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php echo $value['nama_dokter'];?><br>
                                                <?=date('d/m/Y',strtotime($value['tgl_order']))?> - <?php echo $value['jam_mulai'];?>
                                            </td>
                                            <td>
                                                <center>
                                                    <?php
